...
def run_simulation(genomes, config):
    ...
    generation_font = pygame.font.SysFont("Montserrat", 25)
    ...
    while True:
        ...
        # Display Info
        text = generation_font.render("Generation: " + str(current_generation), True, (223, 62, 62))
        text_rect = text.get_rect()
        text_rect.center = (915, 450)
        screen.blit(text, text_rect)

        text = alive_font.render("Still Alive: " + str(still_alive), True, (223, 62, 62))
        text_rect = text.get_rect()
        text_rect.center = (915, 490)
        screen.blit(text, text_rect)
